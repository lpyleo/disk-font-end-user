    ...
    <div class="move-dialog-wrapper">
        ...
        <el-dialog title="选择目录" :visible.sync="dialogVisible">
            <div class="el-dialog-div">
                <el-tree :data="dialogMoveFile.fileTree" :props="defaultProps" :highlight-current="true" default-expand-all
                    @node-click="selectNodeClick"></el-tree>
            </div>
